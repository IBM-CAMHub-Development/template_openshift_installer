...
module "folder" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/folder?ref=4.2"
...
module "resource_pool" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/resource_pool?ref=4.2"
...
module "deployVM_infranode" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/vmware_infravm_provision?ref=4.2"
...
module "NFSServer-Setup" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/config_nfs_server?ref=4.2"
...
module "HTTPServer-Setup" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/config_apache_web_server?ref=4.2"
...
module "HAProxy-install" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/config_lb_server?ref=4.2"
...
module "vmware_ign_config" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/vmware_ign_config?ref=4.2"
...
module "prepare_dns" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/config_dns?ref=4.2"
...
module "bootstrap" {
  source                     = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/machine_boot?ref=4.2"
...
module "wait_for_master_api_url" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/wait_for_api_url?ref=4.2"
...
module "control_plane" {
 ...
 module "get_control_ip" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/get_permanent_ip?ref=4.2" 
...
module "monitor_controlplane_bootstrap" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/monitor_controlplane_bootstrap?ref=4.2"
...
module "complete_bootstrap" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/complete_bootstrap?ref=4.2"
...
module "config_image_registry" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/config_image_registry?ref=4.2"
...
module "complete_install" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/complete_install?ref=4.2"
...
module "set_permanent_ip" {
  source = "github.com/IBM-CAMHub-Development/template_openshift_modules.git//terraform12/vmware/set_permanent_ip?ref=4.2"
