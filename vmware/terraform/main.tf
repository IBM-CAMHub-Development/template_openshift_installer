...
module "folder" {
  source = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/folder"
...
module "resource_pool" {
  source = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/resource_pool"
...
module "deployVM_infranode" {
  source = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/vmware_infravm_provision"
...
module "NFSServer-Setup" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/config_nfs_server"
...
module "HTTPServer-Setup" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/config_apache_web_server"
...
module "HAProxy-install" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/config_lb_server" 
...
module "vmware_ign_config" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/vmware_ign_config"
...
module "control_plane" {
 ...
 module "get_control_ip" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/get_permanent_ip" 
...
module "monitor_controlplane_bootstrap" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/monitor_controlplane_bootstrap" 
...
module "complete_bootstrap" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/complete_bootstrap" 
...
module "config_image_registry" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/config_image_registry" 
...
module "complete_install" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/complete_install" 
...
module "set_permanent_ip" {
  source               = "git::https://github.com/IBM-CAMHub-Development/template_openshift_modules.git?ref=4.2//vmware/set_permanent_ip" 
